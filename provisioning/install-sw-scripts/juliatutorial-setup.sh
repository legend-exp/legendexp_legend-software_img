...
pkg_install() {
    ...
    julia -e 'using Pkg; Pkg.add(["IJulia", "Interact", "WebIO", "Observables", "Widgets", "PackageCompiler", "CUDA", "CUDA_compat_jll", "CUDAKernels"]; preserve=Pkg.PRESERVE_ALL); Pkg.build("IJulia")'
