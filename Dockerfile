...
RUN provisioning/install-sw.sh juliatutorial legend-exp/dcade11 /opt/legend-julia-tutorial
...
RUN true \
    && provisioning/install-sw.sh pygama legend-exp/v1.2.0 /opt/legend-python \
